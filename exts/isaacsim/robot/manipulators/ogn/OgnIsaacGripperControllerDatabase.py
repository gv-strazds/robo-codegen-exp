r"""Support for simplified access to data on nodes of type isaacsim.robot.manipulators.IsaacGripperController
    ...
    class abi:
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                node_type.set_metadata(ogn.MetadataKeys.CATEGORIES, "isaacRobotManipulators")
                node_type.set_metadata(ogn.MetadataKeys.CATEGORY_DESCRIPTIONS, "isaacRobotManipulators,Controller for Grippers")
